...
const App: React.FC = () => {
          ...
          try {
              ...
              if (res.ok) {
                  ...
                  setSystemData(prev => ({
                      ...prev,
                      ...data,
                      music: data.music || prev.music, // Ensure music array exists
  ...
  // Auto-save Data on Change (Debounced)
  useEffect(() => {
      if (isLoading) return;
  ...
  return (
    <div 
        className="relative w-full h-full overflow-hidden bg-cover bg-center transition-all duration-700 font-sans select-none"
